...
SUB2API_ACCOUNT_PAGE_SIZE: int = 20
SUB2API_ACCOUNT_FETCH_TIMEOUT: int = 45
SUB2API_USE_PROXY: bool = False
...
def reload_all_configs():
    ...
    global SUB2API_ACCOUNT_PAGE_SIZE, SUB2API_ACCOUNT_FETCH_TIMEOUT, SUB2API_USE_PROXY
    ...
    SUB2API_ACCOUNT_PAGE_SIZE = safe_int(_sub2api.get("account_page_size", 20), 20, minimum=1)
    SUB2API_ACCOUNT_FETCH_TIMEOUT = safe_int(_sub2api.get("account_fetch_timeout", 45), 45, minimum=5)
    SUB2API_USE_PROXY = safe_bool(_sub2api.get("use_proxy", False), default=False)
